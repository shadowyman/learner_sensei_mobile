...
- packet-owned changed files and relevant generated output
...
2. Report the current backlog row, ExecPlan state, and first missing or next
   actionable gate.
