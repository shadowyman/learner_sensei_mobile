...
const {
  ...
  SENSEI_ENHANCEMENT_CONFIG: CORE_SENSEI_ENHANCEMENT_CONFIG,
...
const SENSEI_ENHANCEMENT_CONFIG = {
  modelName: CORE_SENSEI_ENHANCEMENT_CONFIG.modelName || GEMINI_FLASH,
  timeoutMs: MAIN_RESPONSE_TIMEOUT_MS,
  safetySettings: DEFAULT_SAFETY_SETTINGS,
  config: {
