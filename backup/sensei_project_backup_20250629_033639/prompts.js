 ...
 */
import { MISCONCEPTION_IDS } from "./adaptiveEngine"; // For getComprehensiveAnalysisPrompt
import { PHASE_MASTERY_THRESHOLD } from "./curriculum"; // For CURRICULUM_FOCUS_PROMPT_TEMPLATES
...
${MERMAID_GENERATION_GUIDELINES}
`;
export function SENSEI_SELECTED_TEXT_USER_PROMPT_TEMPLATE_FUNCTION(originalSenseiMessageText, selectedText, instructionText, actionLabel) {
    return `
...
export function SENSEI_ASK_QUESTION_USER_PROMPT_TEMPLATE_FUNCTION(originalSenseiMessageText, selectedText, userQuestion, actionLabel) {
    return `
Here is your original full explanation:
--- ORIGINAL EXPLANATION START ---
${originalSenseiMessageText}
...
export const MODULE_INTRODUCTION_TASK_TEMPLATE = (selectedModuleTitle, firstConceptTitle, phaseDisplayName, userInputText) => `
...
export function MAIN_SENSEI_RESPONSE_SYSTEM_INSTRUCTION_TEMPLATE_FUNCTION(curriculumFocusInstruction, cleanPedagogicalGuidance, isMustObey // The new flag
) {
...
export function GET_TEACHING_PLAN_GENERATION_PROMPT_FUNCTION(textToProcess) {
...
export function GET_SOCRATIC_TEACHING_PLAN_GENERATION_PROMPT(socraticSectionContent, moduleTitle, moduleGoal, conceptsSummary) {
...
export function buildSocraticInitialInstruction(teachingPlan) {
...
export function GET_COMPREHENSIVE_ANALYSIS_PROMPT_FUNCTION(userInputText, lastSenseiMsg, currentTaskIdForAnalysis, expectedContentPointsForCurrentChunk) {
    return `
...
export const CURRICULUM_FOCUS_PRIMARY_ACTION_HEADER_TEMPLATE = (primaryActionType) => `== ⭐ PRIMARY ACTION FOR THIS TURN: ${primaryActionType} ⭐ ==`;
...
export const TARGETED_CONSOLIDATION_PROMPT_TEMPLATE = (item, state, learnerModel, phaseKCMastery) => {
...
export const REVISIT_CLARIFY_CHUNK_PROMPT_TEMPLATE = (focusPointsStrings, includeCheck) => {
...
export const REVISIT_CLARIFY_GENERAL_PROMPT_TEMPLATE = (allRevisitPoints, includeCheck) => {
...
export const TEACH_NEW_CONTENT_CHUNK_PROMPT_TEMPLATE = (focusPointsStrings, includeCheck) => {
...
export const GENERAL_ENGAGEMENT_PROMPT_TEMPLATE = (item, state) => {
